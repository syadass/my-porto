...
const Hero = () => {
  ...
  return (
    <section id="home" className="overflow-hidden scroll-mt-6">
      {/* Tambahkan scroll-mt-24 di sebelah overflow-hidden */}
          ...
          <div className="flex flex-col gap-6 mt-6 md:mt-8">
            {hero.hero_content.map((content, i) => (
              <div
                ...
                className={`flex items-center w-80 gap-6 ${
