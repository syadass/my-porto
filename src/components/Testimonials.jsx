...
const Testimonials = () => {
  ...
  return (
    <section id="experience" className="bg-bg_light_primary scroll-mt-6">
      <div className="md:container px-5 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-4">
          ...
          <div data-aos="fade-up">
            ...
            <div className="flex flex-col gap-6 border-l-2 border-[#D4AF37] ml-3 pl-8">
              {Experience.work.map((item, i) => (
                <div key={i} className="relative">
                  ...
                  <h4 className="text-xl font-bold font-Poppins text-dark_primary">
                    {item.title}
                  </h4>
                  ...
                  {/* Tambahan whitespace-pre-line agar text turun baris */}
                  <p className="font-Poppins text-[0.95rem] leading-relaxed text-slate-700 whitespace-pre-line">
                    {item.desc}
                  </p>
                </div>
              ))}
